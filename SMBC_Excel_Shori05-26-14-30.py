...
#,---------------------------------------------------------*
#,本イニシャルファイルの説明
#,０列目の#はコメント、１はデータファイル名称
#,１列目の１：インプットデータ、２．３，アウトプットデータファイル
#,２列目はデータファイル名称
#,1,1,C:\k-net\rpa\nyusyu.csv
#,1,2,C:\k-net\rpa\仮受デー仮タ2018.xlsx,4月
...
def data_proc2():
#---スペース行の確認-------"
    karimei_max_row = init_proc("2")  # 一次書込ファイルの最終行をゲット
    cntr=0
#仮受処理-------------------------------------------*
    with open(INPUT_CSV) as f:
        reader = csv.reader(f)
